...
export default function ToolSeoReport() {
  const fields: ToolField[] = [
    ...
    { name: 'workDone', label: 'Optimizations & Work Completed', placeholder: 'Describe the SEO optimizations and work completed (e.g. fixed meta titles, optimized page speed, set up schema markup, wrote 3 blog posts)...', type: 'textarea', required: false, maxLength: 2000 },
