...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (!user) {
      ...
      else if (activeMarketingPage === "docs") path = "/docs";
    } else {
                ...
                <div className="space-y-10 text-xs sm:text-sm text-slate-600">
                  ...
                  <div className="space-y-4 text-left">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="p-5 border border-slate-200 bg-slate-50/50 rounded-2xl">
                        <h4 className="font-extrabold text-slate-955 text-sm mb-1.5">White-Labeled Client Portals</h4>
                        <p className="text-slate-550 text-xs leading-relaxed">
                          Give your clients secure logins to a dedicated dashboard matching your agency's logo, colors, and title. Pro plan users can generate custom portal URLs (`/portal/:agencyId`) that preload their brand accents immediately on the login page for a completely white-labeled client experience.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                {[
                  ...
                  },
                  {
                    ...
                    desc: "Our Groq Llama 3.3 compiler compiles detailed progress, KPIs, and goals in seconds.",
                  },
                  {
                    step: "04",
                    ...
                    <div className="space-y-5">
                      ...
                      <div className="space-y-4 pt-2">
                        {[
                          ...
                          {
                            step: "Step 3",
                            title: "Compile with Advanced Llama 3.3 AI Models",
                            desc: "Adjust settings like content length target (brief, detailed) and aesthetic tone (casual, professional). Click 'Generate Section with AI' (Starter Plan) to invoke our high-performance Groq Llama 3.3 compiler, transforming raw notes into fully written business prose summaries."
                          },
                          {
                            step: "Step 4",
                        ...
                        {[
                          {
                            ...
                            a: "ReportIQ connects to high-performance generative models (such as Groq Llama 3.3 model servers). When you click 'Generate Section with AI', it digests all text notes, milestones, links, and documents uploaded to the client workspace, compiling a professionally structured narrative matching your target lengths and aesthetics."
                          },
                          {
                  ...
                  <div className="text-left border-t border-slate-100 pt-8">
                    ...
                    <div className="space-y-3.5">
                      {[
                        ...
                        <div key={idx} className="border border-slate-200 bg-white p-4 rounded-xl">
                          <h5 className="font-bold text-slate-800 text-xs mb-1">{item.q}</h5>
                          <p className="text-slate-550 text-xs leading-relaxed">{item.a}</p>
                        </div>
                      ))}
                    </div>
                  </div>
